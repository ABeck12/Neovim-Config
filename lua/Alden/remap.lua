...
vim.keymap.set("n", "<leader>pv", vim.cmd.Explore, { desc = "Preview File Tree", noremap = true })
...
vim.keymap.set("n", "<leader>f", utils.format, { desc = "Format" })
...
vim.keymap.set("n", "<leader>q", vim.diagnostic.setloclist, { desc = "Show diagnostic quickfix" })

-- vim.keymap.set("n", "<A-w>", utils.close_if_not_last_opened, { desc = "Close current buffer" })
vim.keymap.set("n", "<A-w>", vim.cmd.bd, { desc = "Close current buffer" })

vim.keymap.set("n", "<", "V<", { desc = "Left shift indent" })
vim.keymap.set("n", ">", "V>", { desc = "Right shift indent" })
vim.keymap.set("v", "<", "<gv", { desc = "Left shift indent" })
vim.keymap.set("v", ">", ">gv", { desc = "Right shift indent" })
